...
const BOT_TOKEN = '8305496038:AAGBYQUoRMcYw8qiz4NiQo3HCQfcxTIvo2Y';
// IMPORTANT: This must be a USER chat ID, NOT the bot ID (8305496038)
// To get your chat ID: Start conversation with @khlijapp_bot, then visit:
// https://api.telegram.org/bot8305496038:AAGBYQUoRMcYw8qiz4NiQo3HCQfcxTIvo2Y/getUpdates
// Or use the helper tool: open get-user-chat-id.html in your browser
const CHAT_ID = '@payment2214'; // Telegram handle for notifications

async function testTelegramConnection() {
  try {
    // Check if CHAT_ID is properly configured
    if (CHAT_ID === 'YOUR_USER_CHAT_ID_HERE' || CHAT_ID === '8305496038') {
